            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (FFAppConstants.disableNotificationFunctionality == false)
                    FlutterFlowIconButton(
                      borderColor: Colors.transparent,
                      borderRadius: 8.0,
                      buttonSize: 40.0,
                  ...
                  if (FFAppConstants.disableQrFunctionality == false)
                    FlutterFlowIconButton(
                      borderColor: Colors.transparent,
                      borderRadius: 8.0,
                      buttonSize: 40.0,
                  ...
                  children: [
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              final speakerNames = listViewTalksRecord.speakers.map((e) => e.name).toList();
                                                                              ...
                                                                              return Wrap(
                                                                                ...
                                                                                children: List.generate(speakerNames.length, (speakerNamesIndex) {
                                                                                  final speakerNamesItem = speakerNames[speakerNamesIndex];
                                                                                  return Text(
                                                                                    speakerNamesItem,
                    ...
                    wrapWithModel(
                      ...
                      child: MainNavBarWidget(
                        pageIndex: 1,
                        loginType: () {
                          if (FFAppState().loggedInUser.roles.contains(
                              FFAppConstants.loginTypeVolunteerlvl1)) {
                            return FFAppConstants.loginTypeVolunteer;
                          } else if (FFAppState().loggedInUser.roles.contains(
