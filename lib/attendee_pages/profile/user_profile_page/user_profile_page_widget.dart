  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.userReference != null) {
        ...
        _model.selfUserProfile = await queryUsersRecordOnce(
        ...
        _model.userProfile = _model.selfUserProfile;
        safeSetState(() {});
      }
    });
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if (_model.userProfile?.photoUrl != null &&
                                  _model.userProfile?.photoUrl != '')
                                Card(
                                                ...
                                                onTap: () async {
                                                  if (_model.userProfile
                                                    ...
                                                    ScaffoldMessenger.of(
                                                      ...
                                                      SnackBar(
                                                        content: Text(
                                                          'Please add LinkedIn Url to view QR code',
                                                          style: TextStyle(
                                                            color: FlutterFlowTheme
                                                                    .of(context)
                                                                .primaryText,
