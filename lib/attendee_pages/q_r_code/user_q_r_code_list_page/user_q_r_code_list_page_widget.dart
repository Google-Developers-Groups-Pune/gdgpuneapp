...
class UserQRCodeListPageWidget extends StatefulWidget {
  ...
  State<UserQRCodeListPageWidget> createState() =>
      _UserQRCodeListPageWidgetState();
}

class _UserQRCodeListPageWidgetState extends State<UserQRCodeListPageWidget> {
  late UserQRCodeListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserQRCodeListPageModel());
