...
class AgendaHomeScreenWidget extends StatefulWidget {
  const AgendaHomeScreenWidget({super.key});

  @override
  State<AgendaHomeScreenWidget> createState() => _AgendaHomeScreenWidgetState();
}

class _AgendaHomeScreenWidgetState extends State<AgendaHomeScreenWidget> {
  late AgendaHomeScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendaHomeScreenModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await queryAgendasRecordOnce(
        singleRecord: true,
