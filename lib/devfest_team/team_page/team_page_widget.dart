...
class _TeamPageWidgetState extends State<TeamPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listOfVolunteers = await queryUsersRecordOnce();
    });
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Builder(
            builder: (context) {
              final volunteerList = _model.listOfVolunteers?.toList() ?? [];
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, volunteerListIndex) {
                  final volunteerListItem = volunteerList[volunteerListIndex];
                  return Padding(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  await launchURL(volunteerListItem.linkedin);
                                },
                                child: FaIcon(
