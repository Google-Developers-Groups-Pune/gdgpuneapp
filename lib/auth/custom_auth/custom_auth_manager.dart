...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    gDGPuneAuthUserSubject.add(
      GDGPuneAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GDGPuneAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GDGPuneAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GDGPuneAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    gDGPuneAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
